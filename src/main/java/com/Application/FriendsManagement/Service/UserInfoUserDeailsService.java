...
@Component
public class UserInfoUserDeailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return users.map(user -> (UserDetails)user).orElseThrow(()-> new UsernameNotFoundException("UserName Not found"));
    }
}
